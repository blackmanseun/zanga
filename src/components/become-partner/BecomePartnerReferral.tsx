...
import { FiShare2, FiCheckCircle, FiArrowRight } from 'react-icons/fi'
...
const opportunities: string[] = [
    'Refer qualified prospects',
    'Earn agreed referral fees or commissions',
    'Access sales and marketing materials',
    'Participate in joint business-development activity',
    'Co-host webinars or market-education initiatives',
]

export default function BecomePartnerReferral() {
    return (
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="max-w-3xl">
                    <h2 className="text-3xl md:text-[2.8rem] font-bold mt-3 mb-6 font-MonaSans leading-tight text-gray-700">
                        Introduce Zanga to <br className="hidden md:block"/>organisations that need <br className="hidden md:block"/>better people intelligence
                    </h2>
                </div>
                ...
                <div className="grid md:grid-cols-2 xl:grid-cols-[550px_1fr] gap-10 lg:gap-16 items-start mt-4">
                    <div>
                        <p className="text-gray-500 font-Montserrat leading-relaxed mb-4">
                            <BoldZanga text="Referral partners connect Zanga with qualified organisations and decision-makers who can benefit from our assessments, products and enterprise solutions."/>
                        </p>
                        <p className="text-gray-500 font-Montserrat leading-relaxed mb-8">
                            <BoldZanga text="Zanga manages the sales and delivery process while the partner participates according to the agreed referral model."/>
                        </p>
