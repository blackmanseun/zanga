...
export default function LeadershipAssessmentsCta() {
    return (
        <section className="md:pb-20 pb-14 px-4 sm:px-6 lg:px-8 bg-white">
                        ...
                        <div className="grid md:grid-cols-5 gap-10 items-center">
                            <div className="xl:col-span-3 md:col-span-2">
                                <h2 className="text-3xl md:text-[2.5rem] font-bold font-MonaSans leading-[1.1] text-white mb-4">
                                    See what your leaders<br className="hidden xl:block"/> are capable of
                                </h2>
                                <p className="text-white/60 font-Montserrat leading-relaxed max-w-lg text-md">
                                    Build a clearer picture of leadership capability, potential and
                                    development priorities across your organisation.
                                </p>
                            </div>
