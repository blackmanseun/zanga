  ...
  return (
    <section className="py-14 px-4 sm:px-6 lg:px-8 bg-white border-y border-gray-100">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-gray-700 text-base md:text-lg font-semibold font-Montserrat">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 mt-8">
          {badges.map((badge) => (
            <span
              key={badge.label}
              className="inline-flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-full px-5 py-2.5 text-sm font-medium text-gray-700 font-Montserrat"
            >
        ...
        <p className="text-gray-400 text-sm mt-6 font-Montserrat">
          Evidence-based assessments designed for high-context markets
        </p>
      </div>
    </section>
  )
