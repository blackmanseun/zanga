...
// loop mode has nothing to scroll (and just sits static/left-aligned) if the
// slide track is narrower than the viewport.
const MARQUEE_LOGOS = [...LOGOS, ...LOGOS, ...LOGOS]

export default function PulseLogoMarquee() {
    return (
