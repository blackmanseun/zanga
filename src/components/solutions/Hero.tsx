...
export default function Hero() {
  return (
    ...
    >
      <div className="py-16 md:pt-10 md:pb-20 mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-[7fr_5fr] gap-y-12 md:gap-y-0">
        <div className="md:pt-24 order-1 md:order-none md:col-start-1 md:row-start-1 text-left">
